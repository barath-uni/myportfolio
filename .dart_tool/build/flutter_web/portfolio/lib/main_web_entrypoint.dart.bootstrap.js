...
let modulePaths = {
 ...
 "packages/portfolio/AboutMe": "packages/portfolio/AboutMe.ddc",
 "packages/portfolio/LowerFold": "packages/portfolio/LowerFold.ddc",
 "packages/portfolio/UpperFold": "packages/portfolio/UpperFold.ddc",
 "packages/portfolio/main": "packages/portfolio/main.ddc",
 "packages/portfolio/main_web_entrypoint": "packages/portfolio/main_web_entrypoint.ddc",
...
define("main_web_entrypoint.dart.bootstrap", ["packages/portfolio/main_web_entrypoint", "dart_sdk"], function(app, dart_sdk) {
  ...
  var bootstrap = {
      hot$onChildUpdate: function(childName, child) {
        ...
        if (childName === "package:portfolio/main_web_entrypoint.dart") {
          // Clear static caches.
